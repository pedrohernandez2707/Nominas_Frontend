  ...
  <q-page padding>
    ...
    >
      <div class="row">
        ...
        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-select v-model="modelEmpleado" :options="optionsEmpleado" label="Seleccione Empleado" filled @update:model-value="val =>{getHorasEmpleado(val)}"/>
        </div>

        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-input clearable v-model="horasExtras" type="number" label="Ingrese Total de Horas Extras" />
        </div>

        <div class="col-xs-4 col-md-4 q-pa-md">
          <q-input clearable v-model="horasDobles" type="number" label="Ingrese Total de Horas Dobles" />
        </div>
